                    ...
                    <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms="" class="top-11 w-[230px] !py-0 font-semibold text-dark ltr:right-0 rtl:left-0 dark:text-white-dark dark:text-white-light/90">
                        <li>
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="h-10 w-10 rounded-md object-cover" src="{{ asset('storage/' . Auth::guard('admin')->user()->image) }}" alt="image">
                                </div>
                                <div class="truncate ltr:pl-4 rtl:pr-4">
                                    <h4 class="text-base">
                                        {{ Auth::guard('admin')->user()->name }}<span class="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">Pro</span>
                                    </h4>
                        ...
                        <li>
                            <a href="users-profile.html" class="dark:hover:text-white" @click="toggle">
                                ...
                                <span class="text-end">{{ Auth::guard('admin')->user()->role }}</span></a>
                        </li>                       
                        <li>
                            <a class="dark:hover:text-white" @click="toggle">
                                <svg class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2" width="18" height="18" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="text-end">{{ Auth::guard('admin')->user()->created_at->format('d/m/Y') }}</span></a>
                        </li>
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <a href="{{ url('admin/logout') }}" class="!py-3 text-danger" @click="toggle" onclick="return confirm('¿Estás seguro de cerrar sesión?')">
