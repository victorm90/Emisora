...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('Admin/assets/css/animate.css') }}">
                    ...
                    <div
                        ...
                        <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            <a href="#" class="block w-48 lg:w-72 ms-10">
                                {{-- <img src="{{ asset('Admin/imagen/logologin.jpg') }}" alt="Logo" class="w-full"> --}}
                            </a>
                            <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                <img src="{{ asset('Admin/imagen/login.svg') }}" alt="Cover Image" class="w-full">
                            </div>
                        </div>
                    </div>
                    <div
